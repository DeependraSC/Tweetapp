...
public class TweetServiceImpl implements TweetService {
	...
	public String postTweet(TweetRequestDTO tweetRequest) {
		...
		if (tweets != null) {
			msg = "Success";
			log.info(" Tweet Posted Succesfully ");
			return msg;
		} else {
	...
	private Tweet convertDTOToEntity(TweetRequestDTO tweetRequest) {
		log.info(" Entering convertDTOToEntity ");
	...
	public String postReply(ReplyDTO replyDTO) {
		...
		if (reply != null) {
			msg = "Success";
			log.info("Tweet reply success");
			return msg;
		} else {
			msg = "Internal Server Error Occured";
			log.error("Tweet Reply Failed");
		}
		return msg;
	}

	public Reply converttDTOToReplyEntity(ReplyDTO replyDTO) {
		log.info("Entering converttDTOToReplyEntity");
		DateTimeFormatter dtf = DateTimeFormatter.ofPattern("yyyy/MM/dd HH:mm:ss");
		LocalDateTime now = LocalDateTime.now();
